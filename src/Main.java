                ...
                while (option != 0) {
                    switch (option) {
                        ...
                        case 1:
                            ...
                            String score = JOptionPane.showInputDialog(JOptionPane.showInputDialog(null, "점수를 입력하세요.", "Add Student", JOptionPane.INFORMATION_MESSAGE));
                            Student student = new Student(id, name, age, program, score);
